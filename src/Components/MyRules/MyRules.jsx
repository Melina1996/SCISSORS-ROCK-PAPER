...
export default function MyRules(props) {
  return (
    ...
    <div className='absolute w-screen h-screen bg-opacity-40 bg-black flex justify-center items-center'>
        ...
        <button className='absolute bottom-[100px] md:w-[50%] md:items-center md:relative left-[50%] md:right-0 md:left-0 md:bottom-0 md:justify-end md:flex md:pr-6' onClick={()=>{props.openRules == true ? props.setOpenRules(false) : ""}}><img src={props.close} alt="" /></button>
        </div>

        <div className='w-[100%] h-[80%] flex justify-center items-start md:items-center'>

            <img className='w-[300px] h-auto' src={props.rules} alt="" />
